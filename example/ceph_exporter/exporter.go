...
const (
	...
	defaultCephHostPath     = "/etc/ceph/hosts"
	defaultCephPingOutTime  = 500
...
var (
	...
	CephHostPath       = envflag.String("CEPH_HOST_PATH", defaultCephHostPath, "Ceph host file to cluster")
	CephPingOutTime    = envflag.Int("CEPH_PING_OUTTIME", defaultCephPingOutTime, "Ceph ping host outtime, default 500ms")
)
...
func main() {
	...
	collectors.ReadHostConfig(*CephHostPath, *CephPingOutTime)
